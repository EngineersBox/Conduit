...
public aspect PathFunctionRegistrationAspect {
    ...
    pointcut pathFuncInstantiationVisit(final String functionName):
            execution(public static com.jayway.jsonpath.internal.function.PathFunction com.jayway.jsonpath.internal.function.PathFunctionFactory.newFunction(java.lang.String))
            && args(functionName);
